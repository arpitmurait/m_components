...
class MWidgetConfig {
  ...
  /// Singleton instance
  static final MWidgetConfig _instance = MWidgetConfig._();

  /// Factory constructor to return the singleton instance
  factory MWidgetConfig() => _instance;
  ...
  /// Initialize the MWidget configuration with custom settings
  ///
  /// This method should be called before using any MWidget components,
