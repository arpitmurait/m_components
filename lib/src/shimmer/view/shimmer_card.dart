...
class MShimmerCard extends StatefulWidget {
  final double? height;
  final double? width;
  ...
  @override
  _MShimmerCardState createState() => _MShimmerCardState();
}

class _MShimmerCardState extends State<MShimmerCard> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant MShimmerCard oldWidget) {
...
class _MShimmerCardPainter extends CustomPainter {
  final Color backgroundColor;
  final Color shimmerColor;
